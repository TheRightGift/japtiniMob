...
import { StyleSheet, StatusBar, View, TextInput, Image, ActivityIndicator, TouchableWithoutFeedback} from "react-native";
        ...
        return(
            <View>
                <Card style={styles.container}>
                    ...
                    <Text style={styles.instruction}>Please input  the verification code sent to your phone number.</Text>
...
// Export components.
export default connect(mapStateToProps, {setUserData})(ActivateAccount);